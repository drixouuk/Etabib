...
export default async function BillingPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12 md:px-6 lg:px-8">
      <h1 className="font-heading text-2xl font-bold text-stone-800">Abonnement</h1>
      <p className="mt-1 text-sm text-stone-600 capitalize">{tenant?.name || 'Votre cabinet'}</p>
