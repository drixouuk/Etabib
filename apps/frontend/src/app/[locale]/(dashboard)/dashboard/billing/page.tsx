...
export default async function BillingPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8 md:px-6 lg:px-8">
      <h1 className="font-heading text-[27px] font-bold tracking-tight text-stone-800">Abonnement</h1>
      <p className="mt-1 text-[13.5px] text-stone-600 capitalize">{tenant?.name || 'Votre cabinet'}</p>
      ...
      {subscription ? (
        ...
        <div className="mt-6 rounded-2xl border border-warm bg-white p-5 shadow-sm">
