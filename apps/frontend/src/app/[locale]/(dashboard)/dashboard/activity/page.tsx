...
export default async function ActivityPage({ searchParams }: Props) {
  ...
  return (
    <div className="mx-auto max-w-container px-4 py-12 md:px-6 lg:px-8">
      ...
      <p className="mt-7 mb-3 text-xs font-semibold uppercase tracking-[0.06em] text-ink-softer first:mt-0">Croissance du cabinet</p>
      <div className="rounded-xl border border-warm bg-white p-5 shadow-warm-sm">
        <div className="flex items-baseline justify-between">
          <div>
            <p className="text-[11.5px] font-semibold uppercase tracking-[0.04em] text-ink-softer">Total patients suivis</p>
      ...
      <p className="mt-7 mb-3 text-xs font-semibold uppercase tracking-[0.06em] text-ink-softer first:mt-0">Activité clinique</p>
      <ActivityView
        period={period}
