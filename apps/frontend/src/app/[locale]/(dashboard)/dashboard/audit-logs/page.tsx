...
export default async function AuditLogsPage() {
  ...
  return (
    <div className="mx-auto max-w-container px-4 py-8 md:px-6 lg:px-8">
      <div className="mb-8">
        <h1 className="font-heading text-[27px] font-bold tracking-tight text-stone-800">Registre d&apos;audit (Loi 09-08)</h1>
        <p className="mt-1 text-[13.5px] text-stone-600">Historique immuable des accès et modifications des données de santé.</p>
      </div>
