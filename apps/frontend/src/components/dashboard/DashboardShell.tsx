    ...
    <div data-module="patients" className="flex min-h-screen bg-cream-100">
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <aside className="absolute inset-y-0 start-0 flex w-64 flex-col border-r border-primary-600/15 bg-cream-50 shadow-xl transition-transform duration-300 translate-x-0">
