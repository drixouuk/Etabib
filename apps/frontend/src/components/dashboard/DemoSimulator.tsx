...
export default function DemoSimulator({
  ...
  return (
    <div className="border-t border-primary/15 px-[10px] pt-3 mt-3">
      ...
      <div className="flex items-center gap-1.5 mb-2">
        ...
        <select
          ...
          className="flex-1 rounded-md border border-border bg-card px-2 py-1 text-[11px] text-muted-foreground"
        >
          {tiers.map((t) => (
      ...
      <button
        ...
        className="flex items-center gap-1.5 w-full rounded-md px-2 py-1 text-[11px] text-muted-foreground hover:bg-accent transition-colors"
      >
