      ...
      <section id="rdv" className="scroll-mt-24 border-y border-stone-200 bg-white px-4 py-[68px] md:py-[104px]">
        <div className="container mx-auto max-w-[1160px]">
          <div className="mx-auto mb-12 max-w-[620px] text-center">
            <span className="mb-4 inline-flex items-center gap-2 rounded-full bg-primary-50 px-4 py-2 text-[.82rem] font-bold tracking-wide text-primary-700">{t('title')}</span>
